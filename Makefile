...
install: build_release
	...
	@sudo cp etc/man/{tgr.1,tgr-count.1,tgr-locate.1,tgr-refile.1,tgr-search.1,tgr-tags.1} $(MAN_DIR)
...
uninstall:
	...
	@sudo rm $(MAN_DIR)/{tgr.1,tgr-count.1,tgr-locate.1,tgr-refile.1,tgr-search.1,tgr-tags.1}
