...
complete -c tgr -n "__fish_tgr_needs_command" -f -a "count" -d 'Print the number of tags that matching a pattern'
complete -c tgr -n "__fish_tgr_needs_command" -f -a "locate" -d 'Locate the files that contain a tag matching a pattern'
...
complete -c tgr -n "__fish_tgr_using_subcommand help; and not __fish_seen_subcommand_from count locate refile search sed tags help" -f -a "count" -d 'Print the number of tags that matching a pattern'
complete -c tgr -n "__fish_tgr_using_subcommand help; and not __fish_seen_subcommand_from count locate refile search sed tags help" -f -a "locate" -d 'Locate the files that contain a tag matching a pattern'
